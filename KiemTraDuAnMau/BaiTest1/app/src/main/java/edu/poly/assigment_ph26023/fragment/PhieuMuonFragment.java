...
public class PhieuMuonFragment extends Fragment implements ObjectInterface {
    ...
    private void onpenDialog(Context context, int type) {
        ...
        EditText edBaoQuan = dialog.findViewById(R.id.ed_baoQuan);
        ...
        if (type != 0) {
            ...
            edBaoQuan.setText(phieuMuon.getBaoQuan() + "");
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                phieuMuon.setBaoQuan(Integer.parseInt(edBaoQuan.getText().toString().trim()));
                ...
                if(type == 0) {
                    ...
                    phieuMuon.setNgayThue(sdf.format(new Date()));
